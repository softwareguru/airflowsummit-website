...
gridarea: 3/4/5/5
images:
 - /images/sessions/2026/from-experiment-to-production.jpg
slides: 
video: 
summary: "We’ll share how we use Airflow to orchestrate production ML end-to-end: from feature pipelines in Snowflake, to model training and artifact promotion, to batch scoring and prediction delivery."
