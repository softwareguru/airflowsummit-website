...
gridarea: 6/3/7/4
images:
 - /images/sessions/2026/migrating-airflow-at-scale.jpg
slides: 2026/migrating-airflow-at-scale.pdf
video:
summary: "This talk comes from four years of assisting customers with real migrations across some of the biggest Airflow deployments out there, from self-hosted open source to managed cloud platforms like MWAA, GCC, and Astro, and between major version upgrades."
---
