...
timeslot: 14
gridarea: 7/4/9/5
slides: 2026/spark-airflow-how-orchestration.pdf
video:
images:
 - images/sessions/2026/spark-airflow-how-orchestration.png
summary: Explore key design questions when orchestrating Spark with Airflow. Using real production scenarios, we’ll examine the tradeoffs between orchestration strategies.
---
